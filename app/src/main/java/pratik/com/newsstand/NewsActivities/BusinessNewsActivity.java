...
public class BusinessNewsActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    private BusinessRecyclerAdapter recyclerAdapter;
    ...
    private void setDefaultNewsSource() {
        news_source = getResources().getString(R.string.afr_url);  // When loaded, set news source to only 1 URL - Australian Financial Review //
        //  DULL THE OTHER NEWS SOURCES  //
        View view = findViewById(R.id.bloomberg_logo);      view.setAlpha((float)0.2);
        view = findViewById(R.id.business_insider_logo);    view.setAlpha((float)0.2);
        view = findViewById(R.id.cnbc_logo);                view.setAlpha((float)0.2);
        view = findViewById(R.id.economist_logo);           view.setAlpha((float)0.2);
        view = findViewById(R.id.financial_post_logo);      view.setAlpha((float)0.2);
        view = findViewById(R.id.financial_times_logo);     view.setAlpha((float)0.2);
        view = findViewById(R.id.fortune_logo);             view.setAlpha((float)0.2);
        view = findViewById(R.id.the_wsj_logo);             view.setAlpha((float)0.2);
    }
        ...
        if(!checkConnection())
            ...
            switch (v.getId()){
                case R.id.afr_logo:
                    ...
                    break;
                case R.id.bloomberg_logo:
                    news_source = getResources().getString(R.string.bloomberg_url);
                    view = findViewById(R.id.afr_logo);                 view.setAlpha((float)0.2);
                    view = findViewById(R.id.business_insider_logo);    view.setAlpha((float)0.2);
                    view = findViewById(R.id.cnbc_logo);                view.setAlpha((float)0.2);
                    view = findViewById(R.id.economist_logo);           view.setAlpha((float)0.2);
                    view = findViewById(R.id.financial_post_logo);      view.setAlpha((float)0.2);
                    ...
                    v.setAlpha((float)1.0);
                    break;
                case R.id.business_insider_logo:
                    news_source = getResources().getString(R.string.business_insider_url);
                    view = findViewById(R.id.afr_logo);                 view.setAlpha((float)0.2);
                    view = findViewById(R.id.bloomberg_logo);           view.setAlpha((float)0.2);
                    view = findViewById(R.id.cnbc_logo);                view.setAlpha((float)0.2);
                    view = findViewById(R.id.economist_logo);           view.setAlpha((float)0.2);
                    view = findViewById(R.id.financial_post_logo);      view.setAlpha((float)0.2);
                    view = findViewById(R.id.financial_times_logo);     view.setAlpha((float)0.2);
                    ...
                    break;
                case R.id.cnbc_logo:
                    news_source = getResources().getString(R.string.cnbc_url);
                    view = findViewById(R.id.afr_logo);                 view.setAlpha((float)0.2);
                    view = findViewById(R.id.bloomberg_logo);           view.setAlpha((float)0.2);
                    view = findViewById(R.id.business_insider_logo);    view.setAlpha((float)0.2);
                    view = findViewById(R.id.economist_logo);           view.setAlpha((float)0.2);
                    ...
                    v.setAlpha((float)1.0);
                    break;
                case R.id.economist_logo:
                    news_source = getResources().getString(R.string.economist_url);
                    view = findViewById(R.id.afr_logo);                 view.setAlpha((float)0.2);
                    view = findViewById(R.id.bloomberg_logo);           view.setAlpha((float)0.2);
                    view = findViewById(R.id.business_insider_logo);    view.setAlpha((float)0.2);
                    view = findViewById(R.id.cnbc_logo);                view.setAlpha((float)0.2);
                    ...
                    v.setAlpha((float)1.0);
                    break;
                case R.id.financial_post_logo:
                    news_source = getResources().getString(R.string.financial_post_url);
                    view = findViewById(R.id.afr_logo);                 view.setAlpha((float)0.2);
                    view = findViewById(R.id.bloomberg_logo);           view.setAlpha((float)0.2);
                    view = findViewById(R.id.business_insider_logo);    view.setAlpha((float)0.2);
                    view = findViewById(R.id.cnbc_logo);                view.setAlpha((float)0.2);
                    ...
                    v.setAlpha((float)1.0);
                    break;
                case R.id.financial_times_logo:
                    news_source = getResources().getString(R.string.financial_times_url);
                    view = findViewById(R.id.afr_logo);                 view.setAlpha((float)0.2);
                    view = findViewById(R.id.bloomberg_logo);           view.setAlpha((float)0.2);
                    view = findViewById(R.id.business_insider_logo);    view.setAlpha((float)0.2);
                    view = findViewById(R.id.cnbc_logo);                view.setAlpha((float)0.2);
                    ...
                    v.setAlpha((float)1.0);
                    break;
                case R.id.fortune_logo:
                    news_source = getResources().getString(R.string.fortune_url);
                    view = findViewById(R.id.afr_logo);                 view.setAlpha((float)0.2);
                    view = findViewById(R.id.bloomberg_logo);           view.setAlpha((float)0.2);
                    view = findViewById(R.id.business_insider_logo);    view.setAlpha((float)0.2);
                    view = findViewById(R.id.cnbc_logo);                view.setAlpha((float)0.2);
                    ...
                    v.setAlpha((float)1.0);
                    break;
                case R.id.the_wsj_logo:
                    news_source = getResources().getString(R.string.wsj_url);
                    view = findViewById(R.id.afr_logo);                 view.setAlpha((float)0.2);
                    view = findViewById(R.id.bloomberg_logo);           view.setAlpha((float)0.2);
                    view = findViewById(R.id.business_insider_logo);    view.setAlpha((float)0.2);
                    view = findViewById(R.id.cnbc_logo);                view.setAlpha((float)0.2);
    ...
    public class BusinessRecyclerAdapter extends RecyclerView.Adapter<BusinessRecyclerAdapter.ViewHolder> {
        ...
        ImageLoader imageLoader = new ImageLoader(BusinessNewsActivity.this);
        private final ViewBinderHelper viewBinderHelper = new ViewBinderHelper();

        public BusinessRecyclerAdapter(ArrayList<NewsItemObject> newsItems){
            this.newsItemObjects = newsItems;
        }

        @Override
        public BusinessRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        @Override
        public void onBindViewHolder(final BusinessRecyclerAdapter.ViewHolder holder, final int position) {
    ...
    public class fetch extends AsyncTask<String,Void,ArrayList> {
            ...
            try
            {
                ...
                if (myConnection.getResponseCode() == 200)
                {
                    ...
                    for(int f=0; f<articlesArray.length(); f++)
                    {
                        ...
                        news.setOptionsColor(Color.rgb(63,81,181));
        ...
        protected void onPostExecute(ArrayList result) {
            ...
            listener.onTaskComplete(newsItemObjectArrayList,BusinessNewsActivity.this);
        }
    ...
    public class fetch_completeListener implements AsyncTaskCompleteListener<ArrayList,Activity> {
        ...
        public void onTaskComplete(ArrayList newsItems, Activity ca) {
            ...
            RecyclerView.Adapter adapter = new BusinessRecyclerAdapter(newsItems);
    ...
    public class SaveArticleTask extends AsyncTask<NewsItemObject,Void,String> {
        ...
        BusinessRecyclerAdapter.ViewHolder holder;

        public SaveArticleTask(BusinessRecyclerAdapter.ViewHolder viewHolder){
        ...
        protected void onPostExecute(String responseString) {
            ...
            Toast.makeText(BusinessNewsActivity.this, "Article saved for offline reading", Toast.LENGTH_SHORT).show();
        }

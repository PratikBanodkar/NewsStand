...
public class EntertainmentNewsActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    private EntertainmentRecyclerAdapter recyclerAdapter;
    ...
    private void setDefaultNewsSource() {
        news_source = getResources().getString(R.string.buzzfeed_url);  // When loaded, set news source to only 1 URL - Australian Financial Review //
    ...
    public class fetch extends AsyncTask<String,Void,ArrayList> {
            ...
            try
            {
                ...
                if (myConnection.getResponseCode() == 200)
                {
                    ...
                    for(int f=0; f<articlesArray.length(); f++)
                    {
                        ...
                        news.setOptionsColor(Color.rgb(255, 193, 7));
        ...
        protected void onPostExecute(ArrayList result) {
            ...
            listener.onTaskComplete(newsItemObjectArrayList,EntertainmentNewsActivity.this);
        }
    ...
    public class fetch_completeListener implements AsyncTaskCompleteListener<ArrayList,Activity> {
        ...
        public void onTaskComplete(ArrayList newsItems, Activity ca) {
            ...
            RecyclerView.Adapter adapter = new EntertainmentRecyclerAdapter(newsItems);

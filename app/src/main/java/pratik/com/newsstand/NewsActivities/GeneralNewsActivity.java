...
public class GeneralNewsActivity extends AppCompatActivity {
    ...
    private int activeGeneralSources = 37;
    private RecyclerView recyclerView;
    private GeneralRecyclerAdapter recyclerAdapter;
    private static ArrayList ALL_newsItemObjects;
    private static ArrayList REMOVED_newsItemObjects = new ArrayList();
    private static ArrayList DONT_SHOW_sources = new ArrayList();
    private static String generalURL_abc_news, generalURL_abc_news_au, generalURL_al_jazeera_english, generalURL_associated_press, generalURL_axios;
    private static String generalURL_bbc_news, generalURL_breitbart_news, generalURL_cbc_news, generalURL_cbs_news, generalURL_cnn;
    private static String generalURL_fox_news, generalURL_google_news, generalURL_independent, generalURL_metro, generalURL_mirror;
    private static String generalURL_msnbc, generalURL_nbc_news, generalURL_new_york_magazine, generalURL_news_com_au, generalURL_news24;
    private static String generalURL_newsweek, generalURL_politico, generalURL_reddit_r_all, generalURL_reuters, generalURL_rte;
    private static String generalURL_the_globe_and_mail, generalURL_the_guardian_uk, generalURL_the_hill, generalURL_the_hindu, generalURL_the_huffington_post;
    private static String generalURL_the_new_york_times, generalURL_the_telegraph, generalURL_the_times_of_india, generalURL_the_washington_post, generalURL_time;
    private static String generalURL_usa_today, generalURL_vice_news;
    private ArrayList activeSourceURLs = new ArrayList();
    ...
    public void refreshFeed(View view) {
        ...
        //new FetchTechNewsTask(listener).execute(techURL_ars_technica,techURL_crypto_coins_news,techURL_engadget,techURL_hacker_news,techURL_recode
        //        ,techURL_techcrunch,techURL_techradar,techURL_the_next_web,techURL_the_verge,techURL_wired);
    }
    ...
    public void removeFromBookmarkedArticles(NewsItemObject newsObj) {
        ...
        Gson gson = new Gson();
        String json = savedArticlesPref.getString("General Bookmarked", null);

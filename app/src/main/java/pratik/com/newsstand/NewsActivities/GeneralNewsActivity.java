...
public class GeneralNewsActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    private void setDefaultNewsSource() {
        news_source = getResources().getString(R.string.abc_news_url);  // When loaded, set news source to only 1 URL -ABC News //
        //  DULL THE OTHER NEWS SOURCES  //
        View view = findViewById(R.id.abc_news_au_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.al_jazeera_english_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.associated_press_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.axios_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.bbc_news_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.breitbart_news_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.cbc_news_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.cbs_news_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.cnn_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.fox_news_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.google_news_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.independent_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.metro_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.mirror_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.msnbc_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.nbc_news_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.new_york_magazine_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.news_com_au_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.news24_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.newsweek_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.politico_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.reddit_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.reuters_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.rte_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.the_globe_and_mail_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.the_guardian_uk_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.the_hill_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.the_hill_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.the_hindu_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.the_huffington_post_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.the_new_york_times_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.the_telegraph_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.the_times_of_india_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.the_washington_post_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.time_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.the_usa_today_logo);
        view.setAlpha((float) 0.2);
        view = findViewById(R.id.vice_news_logo);
        view.setAlpha((float) 0.2);
    }

    public void filterChanged(final View v) {
        if(!checkConnection())
            showNoInternetSnackBar();
        else{
            filter = true;
            recyclerView = (RecyclerView) findViewById(R.id.news_recycler_view);
            recyclerAdapter = (GeneralRecyclerAdapter) recyclerView.getAdapter();
            recyclerAdapter.clear();
            v.setAlpha((float) 1.0);
            switch (v.getId()) {
                case R.id.abc_news_logo:
                    news_source = getResources().getString(R.string.abc_news_url);
                    View view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.al_jazeera_english_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.abc_news_au_logo:
                    news_source = getResources().getString(R.string.abc_news_au_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.al_jazeera_english_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.associated_press_logo);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.al_jazeera_english_logo:
                    news_source = getResources().getString(R.string.aljazeera_english_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.associated_press_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.axios_logo);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.associated_press_logo:
                    news_source = getResources().getString(R.string.associated_press_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.axios_logo:
                    news_source = getResources().getString(R.string.axios_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.bbc_news_logo:
                    news_source = getResources().getString(R.string.bbc_news_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.breitbart_news_logo:
                    news_source = getResources().getString(R.string.breitbart_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.cbc_news_logo:
                    news_source = getResources().getString(R.string.cbc_news_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.cbs_news_logo:
                    news_source = getResources().getString(R.string.cbs_news_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    break;
                case R.id.cnn_logo:
                    news_source = getResources().getString(R.string.cnn_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.fox_news_logo:
                    news_source = getResources().getString(R.string.fox_news_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.google_news_logo:
                    news_source = getResources().getString(R.string.google_news_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.independent_logo:
                    news_source = getResources().getString(R.string.independent_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.metro_logo:
                    news_source = getResources().getString(R.string.metro_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.mirror_logo:
                    news_source = getResources().getString(R.string.mirror_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.msnbc_logo:
                    news_source = getResources().getString(R.string.msnbc_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.nbc_news_logo:
                    news_source = getResources().getString(R.string.nbc_news_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.new_york_magazine_logo:
                    news_source = getResources().getString(R.string.new_york_magazine_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.news_com_au_logo:
                    news_source = getResources().getString(R.string.news_com_au_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.news24_logo:
                    news_source = getResources().getString(R.string.news_24_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.newsweek_logo:
                    news_source = getResources().getString(R.string.newsweek_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.politico_logo:
                    news_source = getResources().getString(R.string.politico_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.reddit_logo:
                    news_source = getResources().getString(R.string.reddit_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.reuters_logo:
                    news_source = getResources().getString(R.string.reuters_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    break;
                case R.id.rte_logo:
                    news_source = getResources().getString(R.string.rte_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.the_globe_and_mail_logo:
                    news_source = getResources().getString(R.string.the_globe_and_mail_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.the_guardian_uk_logo:
                    news_source = getResources().getString(R.string.the_guardian_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.the_hill_logo:
                    news_source = getResources().getString(R.string.the_hill_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.the_hindu_logo:
                    news_source = getResources().getString(R.string.the_hindu_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.the_huffington_post_logo:
                    news_source = getResources().getString(R.string.the_huffington_post_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.the_new_york_times_logo:
                    news_source = getResources().getString(R.string.the_new_york_times_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.the_telegraph_logo:
                    news_source = getResources().getString(R.string.the_telegraph_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.the_times_of_india_logo:
                    news_source = getResources().getString(R.string.the_toi_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.the_washington_post_logo:
                    news_source = getResources().getString(R.string.the_washington_post_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    break;
                case R.id.time_logo:
                    news_source = getResources().getString(R.string.time_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.the_usa_today_logo:
                    news_source = getResources().getString(R.string.usa_today_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
                    ...
                    view.setAlpha((float) 0.2);
                    break;
                case R.id.vice_news_logo:
                    news_source = getResources().getString(R.string.vice_news_url);
                    view = findViewById(R.id.abc_news_logo);
                    view.setAlpha((float) 0.2);
                    view = findViewById(R.id.abc_news_au_logo);
                    view.setAlpha((float) 0.2);
    ...
    public class GeneralRecyclerAdapter extends RecyclerView.Adapter<GeneralRecyclerAdapter.ViewHolder> {
        private ArrayList<NewsItemObject> newsItemObjects;
        ImageLoader imageLoader = new ImageLoader(GeneralNewsActivity.this);
        private final ViewBinderHelper viewBinderHelper = new ViewBinderHelper();

        public GeneralRecyclerAdapter(ArrayList<NewsItemObject> newsItems) {
        ...
        @Override
        public void onBindViewHolder(final GeneralRecyclerAdapter.ViewHolder holder, final int position) {
            ...
            holder.article_contents_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent viewArticleIntent = new Intent(GeneralNewsActivity.this, ReadArticleActivity.class);
            ...
            holder.bookmarkImageButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (newsItemObjects.get(position).isBookmarked()) {
                        ...
                        Toast.makeText(GeneralNewsActivity.this, "Article removed from offline reading", Toast.LENGTH_SHORT).show();
                    } else {
                        if(!checkConnection())
                            showNoInternetSnackBar();
                        else{
    ...
    public class fetch extends AsyncTask<String, Void, ArrayList> {
            ...
            try {
                ...
                if (myConnection.getResponseCode() == 200) {
                    ...
                    for (int f = 0; f < articlesArray.length(); f++) {
                        ...
                        news.setOptionsColor(Color.rgb(100, 221, 23));
        ...
        protected void onPostExecute(ArrayList result) {
            ...
            listener.onTaskComplete(newsItemObjectArrayList, GeneralNewsActivity.this);
        }
    ...
    private void showUpdateFeedSnackBar() {
        ...
        View sbView = snackbar.getView();
        TextView textView = (TextView) sbView.findViewById(android.support.design.R.id.snackbar_text);
        textView.setTextColor(Color.rgb(100, 221, 23));
        snackbar.show();
    }
    ...
    public class fetch_completeListener implements AsyncTaskCompleteListener<ArrayList, Activity> {
        ...
        public void onTaskComplete(ArrayList newsItems, Activity ca) {
            ...
            RecyclerView.Adapter adapter = new GeneralRecyclerAdapter(newsItems);
    ...
    public class SaveArticleTask extends AsyncTask<NewsItemObject,Void,String> {
        ...
        GeneralRecyclerAdapter.ViewHolder holder;

        public SaveArticleTask(GeneralRecyclerAdapter.ViewHolder viewHolder){
        ...
        protected void onPostExecute(String responseString) {
            ...
            Toast.makeText(GeneralNewsActivity.this, "Article saved for offline reading", Toast.LENGTH_SHORT).show();
        }

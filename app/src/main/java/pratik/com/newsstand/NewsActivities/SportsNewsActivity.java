...
public class SportsNewsActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    public class SaveArticleTask extends AsyncTask<NewsItemObject,Void,String> {
        ...
        SportsRecyclerAdapter.ViewHolder holder;

        public SaveArticleTask(SportsRecyclerAdapter.ViewHolder viewHolder){
